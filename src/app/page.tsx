...
const features = [
  ...
  {
    title: "מסמכים והצעות בנקים",
    desc: "רשימות מסמכים, תוקף אישורים, השוואת הצעות בנקים ומעקב שכר טרחה.",
    icon: FileText,
  },
];
    ...
    <main className="mx-auto flex min-h-dvh max-w-5xl flex-col px-6 py-16">
      ...
      <section className="mt-24 max-w-2xl">
        ...
        <p className="mt-5 text-lg text-slate-600">
          CRM, סימולטור משכנתאות מתקדם, ניהול מסמכים והצעות בנקים. בנוי על נתונים
